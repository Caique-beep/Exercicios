...
Altere do_twice para que receba dois argumentos, um objeto de função e um valor,
...
Defina uma função nova chamada do_four que receba um objeto de função e um valor e
chame a função quatro vezes, passando o valor como um parâmetro.
...
do_twice(print_twice, arg='spam')
do_four(print_twice, arg='dois')